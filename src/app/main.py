...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description=(
            ...
            "management endpoints, video asset processing endpoints, and OpenAPI documentation."
        ),
        ...
        openapi_tags=[
            ...
            {
                "name": "Assets",
                "description": "Upload-complete and status endpoints for video asset processing.",
            },
        ],
    )
