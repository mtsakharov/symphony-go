...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description=(
            ...
            "management endpoints, chat follow-ups, and OpenAPI documentation."
        ),
        ...
        openapi_tags=[
            ...
            },
            {
                "name": "Chat",
                "description": (
                    "Grounded chat endpoints with bounded per-session follow-up context."
                ),
            },
            {
                "name": "Users",
...
def _build_openapi_schema(app: FastAPI, settings: Settings) -> dict[str, Any]:
    ...
    schema["tags"] = [
        ...
        {
            "name": "Chat",
            "description": "Grounded chat endpoints with bounded per-session follow-up context.",
        },
        {
            "name": "Users",
            "description": "CRUD operations for managing application users.",
